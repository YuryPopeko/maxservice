...
<header class="header">\
	<div class="header__location wrapper only-mobile">\
		...
		<button\
			class="header__location-button"\
			type="button" data-tab="city:brest">\
			Бресту\
		</button>\
		<button\
			class="header__location-button"\
	...
	<div class="header__information wrapper only-desktop">\
		<div class="header__information-tel">\
			<span class="header__phones-city">\
				Брест:\
			</span>\
	...
	<div class="header__panel">\
		...
		<form class="search-form only-desktop">\
			...
			<input\
				type="submit"\
				class="search-submit input-submit-reset"\
				value="">\
		</form>\
		<button\
		...
		<form class="modal modal-feedback wrapper">\
			...
			<input\
				...
				class="feedback__tel">\
			<button\
				class="feedback__submit input-submit-reset">\
				Заказать звонок\
			</button>\
			<button\
				class="modal-close"\
